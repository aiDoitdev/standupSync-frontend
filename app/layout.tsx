...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'StandupSync' }],
  },
  twitter: {
...
const jsonLd = {
  ...
  url: BASE_URL,
  offers: [
    { '@type': 'Offer', price: '0', priceCurrency: 'USD', description: 'Free plan — 1 team, up to 3 members' },
    { '@type': 'Offer', price: '19', priceCurrency: 'USD', description: 'Starter plan — unlimited teams, up to 15 members' },
  ],
  featureList: [
    'AI Task Radar',
